(function(){
  ...
  nv.models.cumulativeLineChart = function(interpolate) {

    //============================================================
    // Public Variables with Default Settings
    //------------------------------------------------------------

    var lines = nv.models.line(interpolate)
  ...
  nv.models.line = function(interpolate) {
  ...
  nv.models.lineChart = function(interpolate) {
    var lines = nv.models.line(interpolate)
      , xAxis = nv.models.axis()
      , yAxis = nv.models.axis()
      , legend = nv.models.legend()
  ...
  nv.models.multiChart = function() {
    ...
    var x = d3.scale.linear(),
        ...
        lines1 = nv.models.line(interpolate).yScale(yScale1),
        lines2 = nv.models.line(interpolate).yScale(yScale2),
  ...
  nv.models.stackedArea = function(interpolate) {
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0}
      ...
      , offset = 'zero'
      , order = 'default'
      , interpolate = interpolate  // controls the line interpolation
      , clipEdge = false // if true, masks lines within x and y scale
      , x //can be accessed via chart.xScale()
      , y //can be accessed via chart.yScale()
  ...
  nv.models.stackedAreaChart = function(interpolate) {

    //============================================================
    // Public Variables with Default Settings
    //------------------------------------------------------------

    var stacked = nv.models.stackedArea(interpolate)
      , xAxis = nv.models.axis()
      , yAxis = nv.models.axis()
      , legend = nv.models.legend()
      , controls = nv.models.legend()
